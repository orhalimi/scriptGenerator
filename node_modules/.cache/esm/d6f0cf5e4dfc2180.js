let TasksDepandedGraph;_4df‍.x([["default",()=>_4df‍.o]]);_4df‍.w("./TasksDepandedGraph",[["default",["TasksDepandedGraph"],function(v){TasksDepandedGraph=v}]]);
...
class Splitter{
    ...
    _addToDependenciesGraph(dependencie, task) {
        console.log('dep')
        _4df‍.g.console.log(dependencie)
        console.log('task')
        _4df‍.g.console.log(task)
        ...
        _4df‍.g.console.log(graphAId)
        console.log('graphidB')
        _4df‍.g.console.log(graphBId)
        let relevantGraph;
        if (!graphA && !graphB) {
    ...
    _mergeGraphs(graphAId, graphBId) {
        ...
        console.log("serA")
        _4df‍.g.console.log(serializedA)
        console.log("serB")
        _4df‍.g.console.log(serializedB)
        ...
        console.log("merge")
        _4df‍.g.console.log(mergedSerialized)
        ...
        _4df‍.g.console.log( this.taskGraphs);
        return mergeGraph;
    }
